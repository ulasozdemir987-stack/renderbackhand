  ...
  try {
    const upstream = await fetch(raw, {
      ...
      headers: {
        ...
        'Accept': 'video/av1,video/webm,video/mp4,video/*;q=0.9,*/*;q=0.8',
...
app.post('/api/stream/start', async (req, res) => {
  ...
  const args = [
    ...
    '-referer', 'https://5gulasozd.lance5g.xyz/',
    '-headers', 'Accept: video/av1,video/webm,video/mp4,video/*;q=0.9,*/*;q=0.8\r\nAccept-Encoding: identity\r\nConnection: keep-alive\r\n',
    '-http_version', '1.1',
    '-probesize', '50M',
    '-analyzeduration', '20M',
    '-i', sourceUrl,
